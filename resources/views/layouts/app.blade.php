        ...
        <nav id="nino-navbar" class="navbar navbar-default" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <li class="active"><img src="/images/CA$HMAP_LOGO.svg" class="img-responsive" alt="Responsive image" style="width:120px;margin-top:-25px;height:120px;"></li>
                </div>
            ...
            <div class="fw" layout="row">
                ...
                <div class="col-md-4 col-sm-6 item ">
                    <div layout="row">
                        ...
                        <div>
                            <h4 class="nino-serviceTitle">Finding Money</h4>
                            <p>لن تقوم بالبحث مطولا عن الصرافات الالية التي ممكن ان تكون غير نشطة... سنقوم بتوضيح جميع الصرافات مع الوصف, ان كانت نشطة او لا</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="sectionContent">
            <div class="row nino-hoverEffect">
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="info">
                        <h4 class="name">Mostafa Alwan</h4>
                        <span class="regency">Web Devlopment</span>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="info">
                        <h4 class="name">Mohamed Saad AK</h4>
                        <span class="regency">Mangement</span>
                    </div>
                </div>
                ...
                <div class="col-md-7 col-sm-4">
                    ...
                    <div class="info">
                        <h4 class="name">hamdon</h4>
                        <span class="regency">Backend Developer</span>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="item">
                    ...
                    <div class="info">
                        <h4 class="name">sara almosamwye</h4>
                        <span class="regency">IOS Developer</span>
                    </div>
                </div>
            </div>
        </div>
...
<footer id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7">
                <p>
                    is a website and application provide locations of ATMs, and other e-payment points of sale
                    with honest reviews from the customers.
                </p>
            </div>

        </div>
        <div class="nino-copyright">Copyright &copy; 2017 </div>
    </div>
</footer>
